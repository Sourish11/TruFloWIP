...
export default function AppPage() {
  ...
  useEffect(() => {
    // First check if user has access code
  ...
  const handleLogout = async () => {
    ...
    revokeAccess(); // Revoke access code when logging out
    navigate("/login");
  };
  ...
  const handleAccessGranted = () => {
    ...
    // Re-run the auth check after access is granted
    const auth = getAuth();
    if (auth.currentUser) {
  ...
  return (
    <>
      ...
      <AccessCodeModal
        ...
        onClose={() => {
          // Don't allow closing without access - redirect to home
          navigate("/");
        }}
      />

      {/* Only show app if access is granted */}
      {hasAccess && (
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white/80 text-sm mb-3">
                      You're using the demo version of TruFlo. Some features may
                      not work as expected or may show sample data.
                    </p>
                    <Button
                      variant="glass"
                      size="sm"
              ...
              <div className="p-4 border-t border-white/10">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="text-center p-2 bg-white/5 rounded-lg">
                    <div className="text-sm font-bold text-green-400 font-ui">
                      8
                    </div>
                    <div className="text-xs text-white/70 font-body">Tasks</div>
                  </div>
                  <div className="text-center p-2 bg-white/5 rounded-lg">
                    <div className="text-sm font-bold text-blue-400 font-ui">
                      2.5h
                    </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-white/10 rounded-lg border border-white/20">
                    <div className="text-right">
                      <div className="text-white/80 text-xs font-ui">
                        Level {userStats.level}
                      </div>
                      <div className="text-white text-sm font-semibold font-ui">
                        {userStats.xp} XP
                      </div>
                    </div>
